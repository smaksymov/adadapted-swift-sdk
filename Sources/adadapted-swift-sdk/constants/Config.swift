...
extension Foundation.Bundle {
    ...
    static var module: Bundle? {
        guard let frameworkBundlePath = Bundle.main.path(forResource: "adadapted-swift-sdk", ofType: "bundle") else {
            return nil
        }
        
        guard let bundle = Bundle(path: frameworkBundlePath) else {
            return nil
        }
